...
def predict( nyanCode, nyanNeo, nyanClass):
	df = pd.DataFrame(
...
#		html.Label('Near-Earth Object'),
       ...
       html.H3('PHA Prediction', className='mb-5'),
...
column3 = dbc.Col(
    [
		dcc.Markdown(
			...
			The closer to 9 this value is, the more dangerous an object potentially is.
			
			-----
			
			An asteroid is classified as a Near-Earth Object if it's closest distance to the Sun, 
			at any point in its orbit, is less than 1.3 astronomical units 
			(au, the mean distance between Earth and the Sun).
